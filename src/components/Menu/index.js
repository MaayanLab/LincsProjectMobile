...
class Menu extends Component {
  constructor() {
    ...
    this.state = {
      menu: [
        {title: 'Home', component: News, props: {passProps: {placeholder: 'Hey there, you passProps bro?'}}},
        {title: 'Style Guide', component: News},
        {title: 'Tabs', component: News},
        {title: 'Forms', component: News},
        {title: 'List Example', component: News, props: {passProps: {noImages: true}}},
        {title: 'List Example 2', component: News},
      ],
    };
  }
